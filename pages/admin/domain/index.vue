  ...
  <div class="app-container">
    ...
    <el-card>
      ...
      >
        ...
        <el-table-column label="注册商" align="center" prop="registrar.name" width="120">
          <template #default="{ row }">
        ...
        <el-table-column label="分类" align="center" prop="category.name" width="120">
          <template #default="{ row }">
        ...
        <el-table-column label="到期时间" align="center" prop="expiryDate" width="120">
          <template #default="{ row }">
    ...
    <el-dialog :title="title" v-model="open" width="800px" append-to-body>
      <el-form ref="domainRef" :model="form" :rules="rules" label-width="120px">
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="注册商" prop="registrarId">
              <el-select v-model="form.registrarId" placeholder="请选择注册商" clearable>
                <el-option
                  v-for="registrar in options.registrars"
                  :key="registrar.id"
                  :label="registrar.name"
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="销售状态" prop="salesStatus">
              <el-select v-model="form.salesStatus" placeholder="请选择销售状态">
                <el-option
                  v-for="status in options.salesStatusOptions"
                  :key="status.value"
                  :label="status.label"
